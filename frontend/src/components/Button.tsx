...
const VARIANTS: Record<Variant, string> = {
  primary:
    "text-editor font-medium text-white bg-primary border border-accent rounded-sm px-3.5 py-1.5 " +
  ...
  mini:
    "leading-none text-gray-500 rounded-sm px-1.5 py-0.5 hover:bg-gray-100 hover:text-gray-900",
  icon:
    "w-6 h-6 grid place-items-center rounded-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900 " +
